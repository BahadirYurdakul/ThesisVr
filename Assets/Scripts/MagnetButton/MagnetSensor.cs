...
public class MagnetSensor : MonoBehaviour
{
    ...
    public bool isPressedMagnetButton = false;
    private int pressedMagnetButtonAtFrame = 0;
	...
	void Update ()
	{
        if (pressedMagnetButtonAtFrame != frameCounter)
            isPressedMagnetButton = false;
		...
		EvaluateModel();
        if (frameCounter == Int32.MaxValue)
            frameCounter = 0;
        frameCounter++;
    ...
    {
        pressedMagnetButtonAtFrame = frameCounter;
        isPressedMagnetButton = true;
    }
}
